...
# API key/token generated by Kalshi for your individual account will handle the authentication needed to get the information and place bets.
# This method is safer than using email and password for authentication.

client = KalshiClient(exchange_api_base=api_base, token=token)
